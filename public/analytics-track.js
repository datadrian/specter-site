(function () {
  ...
  function showBanner() {
    ...
    panel.innerHTML = '<p><strong>OPTIONAL ANALYTICS</strong><br>SPECTER uses first-party analytics only if you agree. It helps measure page and download activity and is not used for cross-site advertising. <a href="/privacy.html">Privacy details</a>.</p><div class="analytics-consent-actions"><button type="button" class="btn-primary" data-analytics-accept>ACCEPT ANALYTICS</button><button type="button" class="btn-ghost" data-analytics-decline>DECLINE</button></div>';
