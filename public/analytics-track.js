(function () {
  ...
  function ready() {
    ...
    if (!document.getElementById('anonymous-analytics-notice') && location.pathname.indexOf('/admin') !== 0) {
      ...
      notice.innerHTML = 'Anonymous page and download-click counts help improve this site. <a style="color:inherit;text-decoration:underline" href="/privacy.html#website-analytics">Privacy and opt out</a>.';
