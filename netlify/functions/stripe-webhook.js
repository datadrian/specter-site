...
// Handles Stripe payment success → generates license key → sends email
...
// Generate a unique license key in format: SPCT-XXXX-XXXX-XXXX-XXXX
  ...
  if (stripeEvent.type === 'checkout.session.completed') {
    ...
    const msg = {
      ...
      from: {
        ...
        name:  'SPECTER Paranormal Imaging',
      },
      subject: 'SPECTER // FIELD LICENSE — Activation Key',
      text: `
SPECTER PARANORMAL IMAGING SYSTEM
LICENSE ACTIVATION

Order ID: ${sessionId}
License Key: ${licenseKey}

Your license is bound to one device. On first launch, enter this key when prompted.

Download:
${process.env.DOWNLOAD_URL || 'https://specterimaging.com/download'}
...
For support: support@specterimaging.com
